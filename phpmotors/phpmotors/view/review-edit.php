...
<html lang = "en-us">
    <head>
        <meta charset="utf-8">
        <title>PHP Motors Review Edit Page</title>
...
<textarea
 id="reviewText" required name="reviewText"><?php if(isset($reviewInfo['reviewText'])){echo "$reviewInfo[reviewText]";}  ?>
</textarea>
...
<input type="submit" name="submit" class="btn" id="reviewbtn" value="Update">
